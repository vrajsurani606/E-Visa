...
<body>
        ...
        <div class="sticky-nav js-sticky-header">
            <div class="container position-relative">
                <div class="site-navigation text-center">
                    ...
                    <a href="" class="btn-book btn btn-secondary btn-sm menu-absolute"><span class="icon-user-o">  USER</span></a>
    ...
    <div class="untree_co-hero inner-page overlay" style="background-image: url('/images/visa4.jpg');">
        <div class="container">
            ...
            <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100" class="active">profile</h1>
               </div>
    ...
    <div class="untree_co-section">
        <div class="container">
                ...
                <section class="vh-50" style="background-color: rgba(19, 106, 213, 0.85);">
      ...
      <div class="col-md-12 col-xl-4">
        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body text-center">
            ...
            <h4 class="mb-2"><?php echo $res['full_name']; ?></h4>
            <p class="text-muted mb-4"><?php echo  $res['full_name'];?> <span class="mx-2">|</span> <a
                href="#!"><?php echo  $res['email'];?></a></p>
            <div class="mb-4 pb-2">
              <button type="button" class="btn btn-outline-primary btn-floating">
                <i class="uil uil-facebook-f "></i>
              </button>
              <button type="button" class="btn btn-outline-primary btn-floating">
                <i class="uil uil-twitter uil-lg"></i>
              </button>
              <button type="button" class="btn btn-outline-primary btn-floating">
            ...
            <button type="submit" class="btn btn-primary btn-rounded btn-lg" name="logout">
              Logout
            </button>
            </form>
