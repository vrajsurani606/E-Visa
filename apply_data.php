...
<body>
    ...
    <div class="untree_co-hero overlay" style="background-image: url('images/img-school-2-min.jpg');">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-12">
                    <div class="justify-content-center ">
                        ...
                        <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Applyer Data</h1>
            ...
            $record=mysqli_num_rows(mysqli_query($con , "Select * from applyer"));
            $pagi=ceil($record/$p_page);
            
          $sql="select * from applyer limit $start,$p_page";
...
if (mysqli_num_rows($res)>0){
    ?><table class="table table-hover" data-aos="fade-up" ><thead><tr><th>Email</th><th>PassPort</th><th>Aadhar</th><th>Visa Type</th></thead></tr>
                            <?php
    while($row=mysqli_fetch_assoc($res)){
        echo "<tr><td>" . $row["email"] . "</td><td>" . $row["passport"] . "</td><td>" . $row["photo"] . "</td><td>" . $row["visa"] . "</td></tr>";
