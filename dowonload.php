                    ...
                    <div class="row justify-content-center ">
                         ...
                         if(!empty($res['status']))
                        {
                            ...
                            if($res['status']=="accept")
                            {
                                echo "..Congratulation..";
                                echo"<br> ";
                                echo "<h3 class='mb-4 heading text-white' data-aos='fade-up' data-aos-delay='100'>Your Visa Are Appriove & Send To Your Email</h3>";
                            }
                            elseif($res['status']=="reject")
                            {
                                {
                                    echo "..Sorry For Trouble..";
                                    echo"<br>";
                                    echo "Your Visa Are Not Appriove & Your Report Are Send To Your Email";
                                }
                            }
                            else
                            {
                                echo "Your Data Is Under Proccess please Wait";
                            }
                        }
                        else{
                            echo " Your Data Are Not Found";
                        }
                            
                            ?>
                            </h1>
                            <div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
                                <p>Just Apply And Wait For Our Response </p>
                            </div>
