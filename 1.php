            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12">
                    <div class="row justify-content-center ">
                        ...
                        <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">User Data</h1>
 <?php
                        //  if ($result->num_rows > 0) {
                          //  ?><!--<table class="table table-hover" data-aos="fade-up" ><thead><tr><th>Name</th><th>Mail</th></thead></tr>
                        <?php
    ...
    <table class="table table-hover"  data-aos="fade-up">
        <?php
            ...
            echo "<tr><th>full_name</th><th>email</th><tr>";
