            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12">
                    <div class="row justify-content-center ">
                        ...
                        <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Contect Us Data</h1>
...
<?php
            ...
            $record=mysqli_num_rows(mysqli_query($con , "Select * from contect"));
            $pagi=ceil($record/$p_page);
            
          $sql="select * from contect limit $start,$p_page";
...
if (mysqli_num_rows($res)>0){
    ?><table class="table table-hover" data-aos="fade-up" ><thead><tr><th>Name</th><th>Mail</th><th>Subject</th><th>Message</th><th>Delete</th></thead></tr>
    <?php                        
    while($row=mysqli_fetch_assoc($res)){
        echo "<tr><td>" . $row["name"] . "</td><td>" . $row["email"] . "</td><td>" . $row["sub"] . "</td><td>" . $row["msg"] . "</td><td>"?>
   <a href="dlt.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Delete</button></a> <?php
    "</td></tr>";
